...
// checkStaleFacts was deleted by PR #32 (refactor/cleanup) — it was an
// exported-but-never-registered dead path that the audit Track F flagged.
// Tests removed alongside the function in that PR.
